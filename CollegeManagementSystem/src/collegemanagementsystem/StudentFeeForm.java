...
//        }catch(Exception e) { }
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] {"Computer Science","Information Technology","Electronics","Electrical","Mechanical","Civil" }));
	comboBox.setForeground(new Color(47, 79, 79));
	comboBox.setFont(new Font("Kumbh Sans", Font.BOLD, 14));
	...
	comboBox_2.setFont(new Font("Kumbh Sans", Font.BOLD, 14));
	...
	t1.setFont(new Font("Kumbh Sans", Font.BOLD, 14));
	t1.setColumns(10);
	...
	b1.setFont(new Font("Kumbh Sans", Font.BOLD, 14));
	...
	b2.setFont(new Font("Kumbh Sans", Font.BOLD, 14));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "Bsc","B.Tech","MCA","Msc","M.Tech" }));
	comboBox_3.setForeground(new Color(47, 79, 79));
	comboBox_3.setFont(new Font("Kumbh Sans", Font.BOLD, 14));
