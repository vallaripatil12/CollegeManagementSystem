...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("collegemanagementsystem.icons/AdminLogin.png"));
